test:
	xcodebuild -workspace Example/Example.xcworkspace -scheme DPMeterViewTests -configuration Release -sdk iphonesimulator -destination platform='iOS Simulator',OS=9.1,name='iPhone Retina (4-inch)' test | xcpretty -c
