...
+ (UIBezierPath *)heartShape:(CGRect)originalFrame
{
    ...
    [bezierPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.49986 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.24129 * CGRectGetHeight(frame))];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.00841 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.36081 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.37259 * CGRectGetWidth(frame), CGRectGetMinY(frame) + -0.06208 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.01079 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.00870 * CGRectGetHeight(frame))];
    ...
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 0.49986 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.24129 * CGRectGetHeight(frame)) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.98938 * CGRectGetWidth(frame), CGRectGetMinY(frame) + 0.00573 * CGRectGetHeight(frame)) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.61811 * CGRectGetWidth(frame), CGRectGetMinY(frame) + -0.06095 * CGRectGetHeight(frame))];
